...
input[type="text"], input[type="email"], input[type="date"], input[type="time"], input[type="search"], input[type="password"], input[type="number"], input[type="tel"], textarea.form-control {
    ...
    border: 1px solid borown;
    border-radius: .3rem;
    color:brown;
    transition: .3s;
    transform-style: preserve-3d;
    -webkit-appearance: none;
    background-color:rgb(248, 87, 141);
    font-size: 1.4rem;
            ...
            <body>
              <div class="fullWidth contactwel">
                <div class="container">
                 ...
                 <p>Plat No.154, B Ayodhaya Nagar,<br>
             Kanha Vihar, Bhura Patel Marg,<br>
             Near stadium,<br>
             Delhi.<br>
             Contact: +91-987654321<br>
             Email: abcd@gmail.com<br>
             <span style="color:brown; text-decoration:underline; font-size:18px;">website :www.movekey.com</span>
            </p>
             
             <div>
              <img src="http://www.sme.in/cirkitelectro/images/contact_us_button.png" class="img-responsive" alt="" width="227px">
             </div>
               ...
               <div class="form-group">
                 <label for="mobile"style="color:brown ">Mobile No :</label>
               ...
               <div class="form-group">
                 <label for="messages"style="color:brown ">Messages :</label>
