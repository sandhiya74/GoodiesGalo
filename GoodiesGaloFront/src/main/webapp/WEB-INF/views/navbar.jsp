	...
	<div class="container-fluide">
		<div class="navbar-header">
			...
			<nav class="navbar navbar-expand-sm navbar-light"
				...
				<img src="${cr2}/img/logo1.png" width="" height="50"
					...
					<c:choose>
						...
						<c:when test="${userrole }">
							<ul class="navbar-nav mr-auto">
								...
								<li class="nav-item"><a class="nav-link"
									href="${cr2}/user/viewcart" ><h6 style="color: brown">Cart<i class="fa fa-shopping-cart"></i><sup>${cartqty}</sup></h6></a></li>
									
								<li class="nav-item"><a class="nav-link" 
							href="${cr2}/user/viewallorders"><h6  style="color: brown">Orders<i class="fa fa-truck"></i></h6></a></li>
